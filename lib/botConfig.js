...
const DEFAULTS = {
    ...
    tablas_mapa_mundo: {
        valor: 'LIST_Lineas_MS_,LIST_Isos_MS_,LIST_Spools_MS_,LIST_Juntas_MS_,REG_EjecucionJuntas_MS,LOG_Spool_MS,LOG_SDI_MS,REL_SDIIso_MS,REG_InspeccionVisual_MS,REG_DimensionalSpool_MS,CAT_TipoUnion_MS,CAT_FluidoServicio_MS,CAT_Personal_MS,LOG_Guia_MS,LIST_Bim_MS',
