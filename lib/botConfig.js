...
const DEFAULTS = {
    ...
    estados_valvula_permitidos: {
        valor: 'Posicionada,Montada',
        descripcion: 'Estados de válvula que el bot puede registrar en REG_MontajeValvulas_MS. El ORDEN define la progresión: solo se acepta un reporte que avance respecto al anterior'
    },
    responder_con_voz: {
        valor: 'true',
