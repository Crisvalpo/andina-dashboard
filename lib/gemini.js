...
Responde ÚNICAMENTE con un JSON válido, sin markdown, con este esquema exacto:
{
  ...
  "intencion": "REGISTRAR_AVANCE" | "CONFIRMAR_REGISTRO" | "CANCELAR_REGISTRO" | "SESION_ESCANEO" | "CONSULTAR_ITEM" | "ENVIAR_ISOMETRICO" | "ENVIAR_FOTO" | "CONSULTA_GENERAL" | "FALTA_DATO" | "SALUDO" | "OTRO",
  "items": [
    {
