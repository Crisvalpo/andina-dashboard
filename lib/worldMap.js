 ...
 * el esquema Supabase 'andina' y el resumen indexado de estados de spools.
 */
async function generarMapaDelMundo(forzar = false) {
    ...
    const resumenSpools = await calcularResumenEstadosSpools();
...
module.exports = { generarMapaDelMundo, calcularResumenEstadosSpools, TABLAS_APPSHEET_DEFAULT };
